...
**Purpose:** Central simulation database for any Svarthird. Provides
parseable YAML structures for band state tracking. The AI reads this at
session start and maintains persistent state.
