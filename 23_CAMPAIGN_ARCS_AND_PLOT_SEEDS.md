...
The story begins in a Rimevegr that is already strained long before the first
full battle is fought. Grain runs thinner than it should. Old grudges remain
unpaid. Men with iron, ships, or winter stores begin speaking as if they own
more than they openly admit. Ordovast presses outward with tribute demands,
fortified ambition, and the belief that fear is the quickest road to order.
Sigrun answers him from the other side of the board, not with noise, but with
roads held open, trade protected, and a harder vision of law that can survive a
bad season. Around them, the Pale Widow moves quietly through the wounds of the
region, healing some, indebting others, and learning exactly where hunger,
shame, and desperation have made people easy to bend.

At first, the campaign does not feel like the end of the world. It feels like a
hard year sliding into a harder one. The Black Axes take work where they can
find it. They escort, guard, bargain, count stores, break camp in the rain, and
try to stay fed without being swallowed by some lord's larger design. But this
is exactly how the trap closes. Every contract draws them deeper into local
feuds, road politics, assembly tensions, healer debts, and private loyalties
that stop being private. What looks like ordinary mercenary life slowly becomes
a map of the whole region's fractures.

The early drama is therefore full of recognizably human stakes. Who controls the
ferry crossing before winter? Which village gets the grain convoy and which one
is told to endure? Who can still appeal to law at the Allthing, and who has to
buy protection through favors, humiliation, or blood? Petra's family troubles do
not stay distant. Gest's ledgers stop being bookkeeping and start becoming a
record of who is being saved, who is being sacrificed, and who is lying about
both. Voss feels the cost of leadership more sharply with each season, because
keeping a band alive often means choosing the least shameful disaster rather than
anything that looks like clean victory. Thorne's buried past does not remain
buried. Dalla begins seeing things nobody else can explain, and the land around
her starts answering in ways that are difficult to dismiss.

Then the political pressure becomes war. Deepholm and Grimholt move from rivalry
and posture into open commitment. Men are levied, roads watched, wagons counted,
alliances tested, and the old excuse of neutrality grows thinner by the week.
The campaign through Y313 is not one grand heroic clash but a grinding sequence
of marches, screens, convoy fights, strained defenses, harbor pressure, bad
orders, smart recoveries, and losses that matter because every dead fighter was
also a carrier of memory, skill, and future possibility. Deepholm's struggle is
not only over who holds a gate. It is over whether the region will be ruled by
tribute-backed force, by lawful resistance, by hidden debt webs, or by whatever
survives the killing.

As the war deepens, the tone darkens with it. The dead are first encountered the
way such things usually are in grim country: as rumor, wrong weather, bad sleep,
animals refusing certain paths, and stories that would be easier to laugh off if
they were not starting to match one another. But the signs gather. Barrows no
longer stay quiet. Patrols vanish. Corpse lights appear where no living camp has
been made. Men begin to return shaken from roads they had walked a dozen times
before. What had seemed like superstition at the edge of the campaign becomes a
second crisis growing underneath the first.

The Long Dark makes everything worse. Hunger sharpens cruelty. Exhaustion strips
away ceremony. Old enemies who would gladly kill one another in daylight now
find themselves bargaining in smoky halls because there are worse things moving
outside the walls. This is one of the campaign's central turns: the human war
has not ended, but it has become impossible to treat it as the only war that
matters. The living are forced, step by step, to realize that their private
ambitions, vendettas, and plans for domination may have spent the very strength
needed to survive what is coming up from beneath the earth.

Y314 opens with an honest attempt to recover. That matters. People count the
dead. Timber is cut. Docks are repaired. Patrols are paid. Trade routes are
reopened where possible. Assemblies gather and try to speak the language of law
again. For a moment, it almost seems as if the region might stitch itself back
into something livable. But that hope only makes the next discoveries hit harder.
The quiet in the barrow fields is wrong. The evidence does not fade. It thickens.
Dalla's visions deepen. Thorne's marks begin to point toward an older truth.
Wardens gather proof that the disturbances are connected. Fragments of buried
knowledge begin to align into a terrifying picture: the dead are not merely
restless, and the old graves are not isolated incidents. The region has been
living over a deeper wound all along.

From there the story becomes not only a struggle for survival, but a struggle to
understand what kind of world the Rimevegr truly is. The Galdr-Forge, the Iron
Barrow, and the linked grave-system beneath the land turn the campaign from a
brutal war saga into something larger and more dreadful. Choices that once looked
local now reveal their full weight. Who kept faith? Who chose expedience? Who
preserved trust? Who profited from fear? Who told the truth when the truth was
most dangerous? The answers to those questions determine not only who reaches the
endgame, but what moral shape the endgame takes.

By Y315, the surviving powers are exhausted, wounded, and bound together by need
more than affection. Yet this is also the point where the campaign becomes most
grand and most intimate at once. The coalition that forms against the deeper
threat is built out of everything that came before: bargains made in winter,
ships saved in storms, debts remembered, insults endured, men buried, promises
kept, and warnings finally believed. The descent toward the Iron Barrow is not a
side quest or sudden twist. It is the earned reckoning of years of human failure,
human endurance, and buried history coming due at once.

What follows can end in several very different ways. In the best versions, the
land survives, but only in scarred form, with entire halls left emptier and peace
purchased at a price nobody can honestly call fair. In darker versions, the dead
are not the only horror: human hunger for control, revenge, or secrecy may finish
the work that war began. And in the darkest path, the old barriers fail badly
enough that the Rimevegr itself starts changing into a place where the living no
longer set the terms. All four ending families grow naturally from the same long
story of oaths, weather, violence, fear, stubborn courage, and the ruinous cost
of learning the truth too late.
...
4. keep the point-of-view hierarchy disciplined so the real plot vessels
   are
the people with leverage, competence, and consequence-bearing choices
...
- Mystery-box revelations should arrive in sequence: first omen, then
  pattern,
then interpretation, then terrible confirmation.
...
- EVT_312_W13_076 and EVT_312_W17_080 — Sigrun calls for allies while the
  Widow
exploits the standoff to annex ground through debt.
- EVT_313_U01_026, EVT_313_U08_033, and EVT_313_U15_040 — the war-cloud
  Allthing
collapses politically and morally, ending the illusion that speech alone
...
- EVT_312_W16_079 and EVT_312_W20_083 — the first Deepholm standoff and
  retreat
define the conflict's opening campaign logic.
...
- EVT_313_U04_029 and EVT_313_U05_030 — Sigrun's defensive mobilization and
  the
southern-pass skirmish prove that both sides are now committed.
...
- EVT_313_U10_035 and EVT_313_U18_043 — trade collapse and war inflation
  must be
treated as campaign events, not background decoration.

#### Supernatural anchors

- EVT_312_U03_023 and EVT_312_U11_031 — Dalla's black-river dream and the
  barrow
stench announce that the land is wrong before the full pattern is visible.
- EVT_312_W11_074 and EVT_312_W15_078 — the Grave Wardens' plea and the
  midwinter
Veil flare establish the first undeniable warning phase.
- EVT_313_U07_032, EVT_313_U12_037, and EVT_313_U20_045 — Dalla's
  escalation,
the Feldwick dead, and the overwhelmed Wardens turn omen into active
threat.
...
- EVT_314_SUP_009, EVT_314_SUP_010, and EVT_314_SUP_012 — the Galdr-Forge
  vision,
organized draugr behavior, and Gudrid's warning identify the true crisis.
...
- EVT_315_SUP_001 through EVT_315_SUP_008 — the regional draugr surge,
  Dalla's
preparation, Thorne's acceptance, the assembled expedition, the forge
chamber, the unbinding, and the surviving cost are the true endgame anchors
and must shape every serious ending path.
...
- **Boolean locks:** true or false conditions for whether something has
  been
learned, chosen, betrayed, or preserved
- **Stage flags:** escalating tracks for personal or supernatural arcs such
  as
dormant, active, severe, irreversible
...
- if knowledge, trust, and cohesion rise together, the hard good endings
  remain
possible even when the cost stays severe
...
- **Hard good endings** require some combination of strong warden
  cooperation,
real forge knowledge, preserved band cohesion, and survivable regional
legitimacy.
...
- **Dark Veil endings** emerge when supernatural pressure outruns
  understanding,
timing, and sacrifice discipline.
...
- Lump can witness consequences, but the key explanatory flashbacks should
  stay
with leverage-bearing characters unless the low-rank view is the point
...
- the engine exists to make the campaign feel inevitable in hindsight
  without
making it predictable too early
...
- when a plan fails, the faction should adapt according to its nature, not
  lose
intelligence for the sake of plot
...
- **Y312:** test tribute, walls, and obedience while mapping which
  settlements
can be bent and which must be broken
- **Y313:** convert preparation into open campaign, siege pressure, and
  legalized
conquest masked as enforcement
...
- **Y312:** secure routes, market trust, and selective alliance options
  without
triggering war before the coast is ready
...
- **Y314:** turn reconstruction, the Allthing, and the barrow tithe into
  proof
that legitimacy can still exist under pressure
- **Y315:** transform emergency coalition into the first real regional
  command
and then into durable governance
...
- **Y313:** let stronger factions bleed while quietly preserving the only
  trade
and healing channels still functioning
...
- **Y315:** secure access to forge knowledge and step into overt authority
  only
after her network has become indispensable
...
- **Y313:** preserve the band through competent war work, ration losses,
  and
refuse vanity engagements
- **Y314:** shift from pure mercenary survival toward selective
  guardianship once
the barrow threat proves regional and structural
...
- **Y312:** keep Lump mainly at the band-floor level — hunger, humiliation,
  labor,
fear, and the question of whether he earns his place
- **Y313:** let him witness what command decisions look like from below
  without
making him the strategic center of the story
- **Y314:** he becomes useful as a proof-of-belonging line; if the band
  survives,
even a man like Lump has a place in that survival
- **Y315:** his late function is emotional continuity and the lived proof
  that the
endgame is about preserving a human world, not just sealing a mechanism
- **Best use:** camp texture, aftershock perspective, small acts of care,
  and rare
low-rank scenes that make the cost of survival concrete
...
- paid work should always alter one or more of these: alignment,
  information,
enemies, trust, route access, or exposure to the Veil problem
- the same contract can begin as practical labor and end as political or
  horror
revelation; that transformation is desirable
- if a contract could be removed without changing later leverage, it is not
  yet
connected tightly enough to the campaign spine
...
- early escort and patrol jobs reveal which roads are safe, which
  settlements can
still pay, and which factions are quietly preparing for trouble
...
- even small jobs should tell Voss and Gest who is buying more iron, grain,
  tar,
or silence than a peaceful year would explain
...
- any contract involving Petra's sister, the Widow's healers, or Thorne's
  past
should bind the personal lattice directly into regional restructuring
...
- every set-piece should revolve around terrain, timing, fatigue, and
  numbers,
not heroic exemption from consequences
...
- **Situation:** outriders, scouts, and light shield groups fight for ridge
  sight,
road access, and the right to force the other side onto worse ground
...
- **Situation:** food carts, river shipments, or mule trains move through
  terrain
where every delay or theft has strategic consequence
...
- **Situation:** hidden archers, boggy footing, broken sightlines, and
  confused calls
turn a routine movement into a survival problem
...
- **Situation:** cargo, berths, fire, and defenders all compete for too
  little space
while commanders are tempted to fixate on the main gate instead
...
- **Situation:** a strike on stores, boats, or sleeping fighters may be
  tactically
smart but politically ruinous depending on who ordered it and who saw it
...
- **Situation:** the force must pull back without turning fear into rout
  while the
enemy or the dead keep steady pressure on the exit
...
- **Situation:** confined stone, wrong echoes, limited light, ritual
  windows, and
enemies that do not behave like living raiders force a different kind of
combat logic
...
- **Situation:** public forms still hold, but every word spoken under
  witness is a
move in a larger leverage struggle
...
- **Situation:** a healer debt, pay discrepancy, transport fee, or
  emergency grain
bargain quietly decides who will owe whom when the next crisis lands
...
- **Situation:** peace or safe passage is guaranteed not by trust but by
  putting a
valued person where betrayal will hurt later
...
- **Situation:** a carefully planted story reshapes hiring, fear, or blame
  without
anyone being able to prove where it began
...
- **Situation:** enemies meet because worse forces press outside the room,
  but every
sentence still tests pride, survival, and whether the agreement can outlast
hunger
...
- **Situation:** someone produces records of tribute, bribes, missing
  stores, or
false accounts and turns numbers into a weapon more powerful than an
accusation alone
...
- **Situation:** grain, boats, road passage, stable space, or healer access
  is
allocated through bargaining that looks administrative but decides life and
death
...
- dreams, strange weather, livestock death, and old marks should feel
  disturbing
but still arguable as coincidence, shame, curse, or harsh season
- Dalla and the most sensitive witnesses notice more than others, but they
  do
not yet possess enough proof to command obedience
...
- breaches, tablet evidence, Dalla's barrow contact, and measurable Veil
  thinning
reveal that the crisis is structural and old
- the Galdr-Forge line changes the meaning of every earlier omen by proving
  the
region sits on a connected buried system
...
- the dead surge, the Iron Barrow is identified, and the final expedition
  is
planned not as a gamble but as the only remaining competent answer
- the forge confrontation determines whether the ladder ends in containment
  or
in a deeper opening that would remake the region permanently
...
- the hub should describe routing clearly enough that another writer can
  pick up
any year-phase without guessing where authority lives
- 23A through 23E should remain the year-owner files, while this document
  holds
the command map and cross-links
...
- prequel hooks should explain the present, and sequel hooks should grow
  from the
scars of Y315 rather than ignore them
...
- N02 and N03 together should determine whether the band reaches N04
  fractured,
cohesive, indebted, or politically exposed
...
- N09 decides whether victory becomes governance, oligarchy, vendetta, or
  merely
temporary breath before the next age of trouble
...
- the two dark endings should differ clearly: one is a human political
  hell,
the other a true Veil catastrophe
...
- the Widow, Ordovast-like successors, rival captains, or councils
  weaponize
scarcity and fear rather than ending them
